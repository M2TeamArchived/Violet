...
namespace FFmpegInterop
{
	...
	ref class AudioStreamInfo sealed : public IStreamInfo
	{
	public:
	...
	ref class VideoStreamInfo sealed : public IStreamInfo
	{
	public:
	...
	ref class SubtitleStreamInfo sealed : public IStreamInfo
	{
	public:
